...
<div id="center">
	...
	<td id="fontStyleTopbar" width="15%" align="center"><a href="../StorySense/Profile.jsp"><img src="images/HomeButtons/Profile.png" onmouseover="this.src='images/HomeButtons/ProfileB.png'" onmouseout="this.src='images/HomeButtons/Profile.png'"  border="0" width="160"/></a></td>
