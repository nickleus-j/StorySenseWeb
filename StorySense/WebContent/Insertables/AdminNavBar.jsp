...
<div style="Clear:both;"></div>
	...
	<td id="fontStyleTopbar" width="15%" align="center"><a href="../StorySense/AdminControlCenter.jsp"><img src="images/HomeButtonsAdmin/settings.jpg" width="160" onmouseover="this.src='images/HomeButtonsAdmin/settingsSelected.jpg'" onmouseout="this.src='images/HomeButtonsAdmin/settings.jpg'"/></a></td>	
	<td id="fontStyleTopbar" width="15%" align="center"><a href="../StorySense/ViewRelationsAdmin.jsp"><img src="images/HomeButtonsAdmin/relationsLearned.jpg" width="160" onmouseover="this.src='images/HomeButtonsAdmin/relationsLearnedSelected.jpg'" onmouseout="this.src='images/HomeButtonsAdmin/relationsLearned.jpg'"/></a></td>
